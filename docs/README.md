...
By design, it helps you with in three major arias and of course, a combination of them.
...
-  How can I mark task as complete;

![how can I create a new task](how-can-i-add-a-task.jpg)

## Utilize the system – Do it for me

Exposing the system’s API to the assistant, truly enriches the user experience with a quite few new options:
...
Give clear, unambiguous, and as-specific-as-possible instructions — and please, don’t make spelling mistakes.
